...
$(document).ready(function () {
    ...
    $('#submit').click(function () {
        ...
        $('#tblsuppContactDetails tr').each(function (index, ele) {
        ...
        $('#tblrequestSupplierQualityDetail tr').each(function (index, ele) {
            console.log(index, ele);
        ...
        $('#tblSupplierMachineryDetails tr').each(function (index, ele) {
            console.log(index, ele);
            console.log($('.MachineName', this).val());
